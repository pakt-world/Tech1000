...
import { BountyCancellationSuccessRequested } from "./bounty-cancellation-success-requested";

const BOUNTY_CANCEL_REASONS = [
	"Ambassador is not responsive",
...
export const RequestBountyCancellation: FC<RequestBountyCancellationProps> = ({
	bountyId,
	...
	return (
		<>
			<div className="flex items-center justify-between bg-hover-gradient px-4 py-6 text-3xl font-bold text-white">
			...
			<div className="container_style flex h-full grow flex-col gap-6 px-4 py-6">
				<div className="input-style-2 rounded-2xl p-4 text-white">
					The ambassador will need to accept for the cancellation to
					be effective.
				</div>
				...
				<div className="flex flex-col gap-6">
					<div className="input-style-2 rounded-2xl p-4 text-white">
						...
						the ambassador. Ambassador will review partner but
						Partner cannot review ambassador.
					</div>
