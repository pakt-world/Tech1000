...
export default function GroupsAdminPage4Mobile({
	groupAdmins,
	...
	return (
		<div className=" flex w-full flex-col gap-6 overflow-y-auto overflow-x-hidden">
			{(groupAdmins.length ?? 0) > 0 ? (
				<CardView className="flex !min-h-[200px] w-full flex-col gap-4 overflow-x-scroll rounded-none !bg-transparent !px-3 !py-2 !backdrop-blur-none">
				...
				<PageEmpty
					...
					className="max-h-[300px] w-full rounded-none "
				/>
			)}
		</div>
	);
