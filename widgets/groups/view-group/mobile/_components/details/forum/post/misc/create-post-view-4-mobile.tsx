...
export default function CreatePostView4Mobile(): ReactElement | null {
	...
	const onSubmit = (data: PostFormValues) => {
		...
		createPost(createPostData, {
			onSuccess: () => {
				...
				queryClient.invalidateQueries(["get-top-posts", groupId, 10]);
	...
	return (
		<div className=" flex !h-[78vh] w-full flex-col gap-4 rounded-none border-2 border-white/20  bg-ink-darkest/40 from-white via-transparent to-white p-4 !px-3 !pb-10 !pt-3 backdrop-blur-sm">
			<form
				className="relative h-full w-full"
				onSubmit={handleSubmit(onSubmit)}
			>
				<div className="flex w-full items-center justify-between border-b border-[#E8E8E81A] pb-4">
				...
				<div
					className=" flex h-fit !max-h-[60vh] w-full flex-col justify-between gap-1"
				...
				>
					...
					{/* Attachments Preview */}
					<div className="absolute bottom-[190px] left-0 mt-4 flex flex-col flex-wrap gap-4 pb-2">
				...
				{/* Controls */}
				<div className=" fixed bottom-16 left-0 flex  w-full flex-col items-start justify-between gap-4 border-t border-[#E8E8E81A] px-3 pb-2 pt-4">
					<div className=" bottom-0 right-0 w-full pb-2 text-right font-circular text-sm text-white">
					...
					<div className=" flex items-start gap-4">
						<LucideBold
							...
							color={
								editor?.isActive("bold") ? "#CCF975" : "#ffffff"
							}
						/>
						...
						{linkPopoverVisible && (
							<div
								...
								style={{
									top: `${
										// @ts-ignore
										linkIconRef?.current?.offsetTop + 30
									}px`,
						...
						<label
							...
							className={` text-white ${
								attachments.length < 4 && !isUploadingImage
									? "cursor-pointer"
									: ""
							}`}
						>
					...
					<div className="flex w-full">
						<Button
							...
							className="ml-auto w-full rounded-full px-8 py-2 font-circular text-black"
						>
