...
export const BountyCard = ({
	...
	return (
		<Button
			className={cn(
				"primary_border-y flex w-full cursor-pointer flex-col items-start gap-2 rounded-none !p-4 duration-200 hover:shadow-md",
				{
					"border-b-2 border-t-2 !border-white shadow-lg": isSelected,
				}
			)}
			onClick={() => {
				if (isSelected) {
